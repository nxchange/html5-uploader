 ...
 *
 * @param options
 * @param options.el. Can be a DOM reference or a CSS selector. Supported tags
...
Uploader.prototype._setFormData = function() {
...
Uploader.prototype._upload = function() {
  ...
  if (this.files.length === 0 && typeof this.$el === 'string') {
